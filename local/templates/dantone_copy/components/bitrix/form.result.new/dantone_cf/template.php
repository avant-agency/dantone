...
<div class="checkboxes-rit control">
    <label class="privacy-checkbox">
        ...
        <div class="control-btn">
				<input class="btn btn-blue full-size btn-large" id="contact_form_submitter" <?=(intval($arResult["F_RIGHT"]) < 10 ? "disabled=\"disabled\"" : "");?> type="submit" name="web_form_submit" value="<?=htmlspecialcharsbx(strlen(trim($arResult["arForm"]["BUTTON"])) <= 0 ? GetMessage("FORM_ADD") : $arResult["arForm"]["BUTTON"]);?>" />
        </div>
