...
<?=$arResult["FORM_HEADER"]?>
	...
	<div class="control">
		<input type="text" class="input-text input-full phone-input" name="form_text_<?=LANGUAGE_ID=='en'?8:2?>" required="required" placeholder="<?=GetMessage('CALLBACK_PHONE')?>" title="<?=GetMessage('CALLBACK_PHONE')?>" />
