<form class="catalog-filters-form" id="dantone_filter_box">
    ...
    <input type="hidden" name="filter[height_60_70]" />
    <input type="hidden" name="filter[height_70_80]" />
    <input type="hidden" name="filter[height_80_90]" />
