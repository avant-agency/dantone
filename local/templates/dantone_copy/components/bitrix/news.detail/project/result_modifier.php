...
if($arParams['LANGUAGE_ID']=='en'){
		if($arResult['PROPERTIES']['ENG_NAME']['VALUE'])$arResult['NAME']=$arResult['PROPERTIES']['ENG_NAME']['VALUE'];
		if($arResult['PROPERTIES']['ENG_DETAIL_TEXT']['VALUE'])$arResult['DETAIL_TEXT']=$arResult['PROPERTIES']['ENG_DETAIL_TEXT']['~VALUE']['TEXT'];
}