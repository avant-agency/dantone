		...
		if (count($arResult["ERRORS"]) > 0):
			foreach ($arResult["ERRORS"] as $key => $error)
				...
				<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" class="registration-form" enctype="multipart/form-data">
					...
					<div class="control-group">
					<div class="control">  <label class="checkbox a-checkbox privacy-checkbox"><input class="required" data-name="<?=GetMessage('ORDER_PRIVACY')?>" type="checkbox" required="required" name="" value="Y"/></label>
