...
$MESS["SOA_PAY_LINK"] = "If you don't see any payment information, click here: <a class=\"btn btn-blue\" href=\"#LINK#\" target=\"_blank\">Pay and place order</a>.";
$MESS["SOA_PAY_PDF"] = "Click <a href=\"#LINK#\" class=\"btn btn-blue\" target=\"_blank\">Download invoice</a> to get the invoice in PDF format.";
...
$MESS['ORDER_MAIN'] = "Main";
$MESS['ORDER_NAME'] = "Place the order";
$MESS['ORDER_PERSONAL'] = "Personal info";
$MESS['ORDER_DELIVERY'] = "Delivery";
$MESS['ORDER_PAYMENT'] = "Payment";
$MESS['ORDER_PERSONAL_TEXT'] = "Please double-check the entered data so that we can reach you.";
$MESS['ORDER_FULL_NAME'] = "Type your full name";
$MESS['ORDER_FULL_NAME_SHORT'] = "Name";
$MESS['ORDER_LAST_NAME'] = "Your last name";
$MESS['ORDER_LAST_NAME_SHORT'] = "Last name";
$MESS['ORDER_EMAIL'] = "Type correct e-mail";
$MESS['ORDER_PHONE'] = "Type correct phone number";
$MESS['ORDER_PHONE_SHORT'] = "Phone";
$MESS['ORDER_CITY'] = "Your city";
$MESS['ORDER_CITY_SHORT'] = "City";
$MESS['ORDER_CHOOSE_DELIVERY'] = "Choose a delivery method";
$MESS['ORDER_DELIVERY_TITLE'] = "Choose a delivery method for your order";

$MESS['ORDER_DELIVERY_TRANSPORT'] = "Delivery by Dantone Home (Moscow+region)";
$MESS['ORDER_DELIVERY_SELF'] = "Customer pick-up";
$MESS['ORDER_DELIVERY_OTHER'] = "Delivery by another transport company";
$MESS['ORDER_PAYMENT_CASH_DELIVERY'] = "Payment on delivery (cash or bank card)";

// $MESS['ORDER_DELIVERY_TRANSPORT'] = "Delivery by a transport company in Moscow ";
// $MESS['ORDER_DELIVERY_SELF'] = "Customer pick-up";
// $MESS['ORDER_DELIVERY_OTHER'] = "Delivery by another transport company";
$MESS['ORDER_DELIVERY_OTHERCITY'] = "Delivery to another city";
$MESS['ORDER_DELIVERY_INPUT'] = "Type name of other transport company";
$MESS['ORDER_DELIVERY_NO'] = "No";
$MESS['ORDER_ADDRESS_REGION'] = "Region";
$MESS['ORDER_ADDRESS_REGION_COMMENT'] = "Example:  Saint-Petersburg";
$MESS['ORDER_ADDRESS_CITY'] = "City";
$MESS['ORDER_ADDRESS_CITY_COMMENT'] = "Example:  Saint-Petersburg";
$MESS['ORDER_ADDRESS_STREET'] = "Street";
$MESS['ORDER_ADDRESS_STREET_COMMENT'] = "Please make sure to enter correct delivery address ";
$MESS['ORDER_ADDRESS_HOUSE'] = "House number";
$MESS['ORDER_ADDRESS_KORPUS'] = "Housing";
$MESS['ORDER_ADDRESS_FLAT'] = "Fl.";
$MESS['ORDER_ADDRESS_INDEX'] = "Postal code";
$MESS['ORDER_ADDRESS_KNOWINDEX'] = "If you don’t know your postal code please,";
$MESS['ORDER_ADDRESS_FINDINDEX'] = "click here";
$MESS['ORDER_ADDRESS_COMMENT'] = "Address comment";
$MESS['ORDER_ADDRESS_COMMENT_COMMENT'] = "If you would like to provide any additional information,<br> please leave your comment here";
$MESS['ORDER_PAYMENT_CHOOSE'] = "Choose the payment option";
$MESS['ORDER_PAYMENT_TITLE'] = "Please choose a payment option for your order";
$MESS['ORDER_PAYMENT_CASH'] = "Payment in cash in our showroom";
$MESS['ORDER_PAYMENT_BANK'] = "Payment with a credit card";
$MESS['ORDER_PAYMENT_NOCASH'] = "Payment to a bank account(for legal entities only)";
$MESS['ORDER_PAYMENT_KVIT'] = "Payment with a money order";
$MESS['ORDER_COMMENT'] = "Comment";
$MESS['ORDER_PLACE'] = "Place your order";
$MESS['ORDER_FIELD'] = "Fields";
$MESS['ORDER_REQUIRED'] = "required";
$MESS['ORDER_WRONG_EMAIL'] = "Введите корректный E-mail";
$MESS['CONFIRM_TITLE'] = "Checkout";
$MESS['CONFIRM_THANK'] = "Thanks for your order. Your order #NUMBER#. <br>Our manager will contact you soon.";
$MESS['CONFIRM_RUB'] = "rub.";
$MESS['CONFIRM_SHT'] = "pcs.";
$MESS['CONFIRM_CHECK'] = "Please check the order information. Found a mistake?  Please contact us at ";
$MESS['CONFIRM_SAYUS'] = "";
$MESS['CONFIRM_TOTAL'] = "Total order amount";
$MESS['CONFIRM_PERSONAL'] = "Contact information";
$MESS['ORDER_WANT_SUBSCRIBE'] = "I want to receive information about new products";
$MESS['ORDER_PRIVACY'] = "Agreement for the processing of personal data";
$MESS['BACK_TO_CATALOG'] = "Back to catalog";
?>