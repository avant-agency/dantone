...
elseif(count($arItems)==2):
	...
	if($arResult['IBLOCK_SECTION_ID']){
		...
		$nav = CIBlockSection::GetList(Array("SORT"=>"­­ASC"), Array("IBLOCK_ID" => $arResult['IBLOCK_ID'], "ID" => $ids), false, array('ID', 'UF_RECOMMENDS'));
	...
	$this->__component->SetResultCacheKeys(array('NAME', 'DETAIL_TEXT', 'SECTION', 'RECOMMENDS'));