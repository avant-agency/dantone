...
$MESS['ORDER_PERSONAL_TEXT'] = "Проверьте правильность введенных данных. Если где-то будет ошибка, мы не сможем с вами связаться и уточнить детали заказа.";
...
$MESS['ORDER_EMAIL'] = "Введите верный электронный адрес";
$MESS['ORDER_PHONE'] = "Указывайте верный номер телефона";
...
$MESS['ORDER_DELIVERY_TRANSPORT'] = "Доставка от Dantone Home (москва+область)";
$MESS['ORDER_DELIVERY_SELF'] = "Самовывоз (склад или шоурум)";
$MESS['ORDER_DELIVERY_OTHER'] = "Доставка другой транспортной компанией";
...
$MESS['ORDER_ADDRESS_STREET_COMMENT'] = "Укажите верный адрес для успешной доставки";
...
$MESS['ORDER_PAYMENT_CASH'] = "Оплата в шоуруме наличными или бакнковской картой";
...
$MESS['CONFIRM_THANK'] = "Cпасибо за заказ. Номер Вашего заказа #NUMBER#. Наш менеджер свяжется с Вами в ближайшее время.";
