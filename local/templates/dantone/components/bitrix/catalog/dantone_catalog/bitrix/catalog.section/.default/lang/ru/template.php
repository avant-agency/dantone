...
$MESS['CATALOG_SECTION_DESCRIPTION']='<p>Мебель Dantone Home – для тех, кто ценит ручной труд, детали и функциональность. Для тех, кто не морщит нос при виде клейма “Made in Russia”. Мы создаём предметы интерьера для квартир и загородных домов, кафе и ресторанов, офисов и салонов.</p>
<p>Dantone Home – современная и качественная мебель в американском стиле. Сделано в России.</p>
';
$MESS['CATALOG_SORT']='Сортировать';
$MESS['CATALOG_SORT_POPULAR']='По популярности';
$MESS['CATALOG_SORT_PRICE']='По цене';
$MESS['CATALOG_SORT_DISCOUNT']='Со скидкой';
$MESS['CATALOG_TOCART']='В корзину';
$MESS['CATALOG_SECTION_FROM']='От';
$MESS['CATALOG_SECTION_SEE']='Посмотреть детали';
?>