...
find . -name '*.csv' -exec chmod a+w {} \;
find . -name '*.sql' -exec chmod a+w {} \;
find . -name '*.xml' -exec chmod a+w {} \;
find . -name '*.json' -exec chmod a+w {} \;
find . -name 'log' -exec chmod a+w {} \;
find . -name 'logs' -exec chmod a+w {} \;
find . -name 'cache' -exec chmod a+w {} \;
find . -name 'tmp' -exec chmod a+w {} \;
find . -name 'upload' -exec chmod a+w {} \;
find . -name 'uploads' -exec chmod a+w {} \;
find . -name 'backup' -exec chmod a+w {} \;
find . -name 'backups' -exec chmod a+w {} \;
chmod a-w `pwd`